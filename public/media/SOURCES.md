# Material del set · aportado por el cliente

Los medios se prepararon para la landing manteniendo el encuadre original; el video se optimizó para una carga fluida en teléfonos. Son los únicos medios fotográficos y de video mostrados en la landing actual. Los archivos de campañas anteriores permanecen en disco, pero no se publican en la interfaz ni en sus metadatos.

| Archivo en la web | Original suministrado | Uso |
| --- | --- | --- |
...
Origen del video: `/Users/mac/Downloads/SET NAVIDAD VIDEO.mp4`.
